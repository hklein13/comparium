...
const fishCategories = {
    ...
    "Barbs": ["cherryBarb", "tigerBarb", "rosyBarb", "goldBarb", "odessaBarb", "denisonBarb", "fiveBandedBarb"],
    "Danios": ["zebraDanio", "pearlDanio", "celestialPearlDanio"],
    "Rasboras": ["harlequinRasbora", "chiliRasbora", "exclamationPointRasbora", "microrasbora"],
    "Rainbowfish": ["boesemansRainbowfish", "dwarfNeonRainbowfish", "turquoiseRainbowfish", "redRainbowfish", "threadfinRainbowfish"],
    "Minnows": ["whiteCloudMinnow"],
    "Livebearers": ["guppy", "molly", "balloonMolly", "blackMolly", "platy", "variatusPlaty", "swordtail", "endlersLivebearer", "leastKillifish"],
    "Bettas & Labyrinth Fish": ["bettaFish", "bettaImbellis", "paradiseFish"],
    "Gouramis": ["dwarfGourami", "honeyGourami", "pearlGourami", "sparklingGourami", "threeSpotGourami", "chocolateGourami"],
    "Cichlids": ["angelfish", "germanBlueRam", "bolivianRam", "kribensis", "cockatooDwarfCichlid", "electricBlueAcara", "firemouthCichlid", "convictCichlid", "africanButterflyCichlid", "discus"],
    "Corydoras Catfish": ["corydoras", "pandaCory", "bronzeCory", "pepperedCory", "sterbaiCory", "juliiCory", "albinoCory", "pygmyCory", "saltAndPepperCory"],
    "Loaches": ["kuhliLoach", "yoyoLoach", "dwarfChainLoach", "zebraLoach", "clownLoach", "hillstreamLoach"],
    "Plecos & Algae Eaters": ["otocinclus", "bristlenosePleco", "clownPleco", "commonPleco", "rubberLipPleco", "chineseAlgaeEater"],
    "Other Catfish": ["stripedRaphaelCatfish", "glassCatfish", "upsideDownCatfish"],
