...
class GlossaryManager {
  ...
  initializeGlossaryData() {
    ...
    const speciesEntries =
      typeof generateGlossaryEntries === 'function' && typeof fishDatabase !== 'undefined'
        ? generateGlossaryEntries(
            fishDatabase,
            typeof fishDescriptions !== 'undefined' ? fishDescriptions : {}
          )
        : [];
      ...
      diseases: [
        {
          ...
          description:
            'A common parasitic disease that appears as white spots on fish bodies and fins. Caused by stress, poor water quality, or temperature fluctuations. Highly contagious but treatable with medication and temperature increase.',
          imageUrl: null,
        ...
        },
        {
          ...
          description:
            'Bacterial infection causing fins to appear ragged, torn, or discolored. Often starts at the edges and progresses inward. Caused by poor water quality, stress, or injury. Treat with antibacterial medication and water changes.',
          imageUrl: null,
        ...
        },
        {
          ...
          scientificName: 'Various bacterial infections',
          description:
            'Serious condition where fish appear swollen with protruding scales (pinecone appearance). Usually caused by internal bacterial infection. Difficult to treat; often requires antibiotics and salt baths. Quarantine affected fish immediately.',
          imageUrl: null,
...

        {
          ...
          scientificName: 'Various bacterial infections',
          description:
            'Swelling and protrusion of one or both eyes caused by fluid buildup behind the eye. Unilateral (one eye) cases usually result from injury or localized infection. Bilateral (both eyes) indicates systemic infection or poor water quality. Symptoms include bulging eyes, cloudy eyes, loss of vision, and lethargy. Caused by poor water quality, bacterial infection, internal parasites, or tuberculosis. Treatment includes water changes, antibacterial medications, Epsom salt baths (1-3 tsp/gallon), and addressing underlying causes. Prognosis is good if treated early.',
          imageUrl: null,
...

        {
          ...
          description:
            'Bacterial infection causing open sores and ulcers on the body. Symptoms include red, open wounds, raised scales around lesions, lethargy, loss of appetite, and secondary fungal infections. Ulcers typically start as red spots that develop into deep, crater-like wounds. Caused by Aeromonas bacteria entering through injuries, poor water quality, and stress. Treatment involves antibacterial medications (kanamycin, enrofloxacin), topical treatments for accessible ulcers, improved water quality, and salt baths. Severe cases may require veterinary care. Secondary infections are common.',
          imageUrl: null,
...

        {
          ...
          description:
            'Disc-shaped crustacean parasites (3-10mm) visible to the naked eye, appearing as translucent/green spots on fish. Use suckers to attach and feed on blood. Symptoms include visible lice, scratching, jumping, red inflammation, lethargy, flashing, and secondary infections. Can move between fish. Common in pond fish but can affect aquarium fish. Treatment involves manual removal, antiparasitic medications (potassium permanganate, organophosphates, salt dips), and treating water to kill eggs and juveniles. Quarantine new fish for 2-3 weeks.',
          imageUrl: null,
          tags: ['Parasitic', 'External', 'Visible', 'Treatable', 'Crustacean'],
          category: 'diseases',
          author: 'System',
...

        {
          ...
          description:
            'Fungal infection specifically targeting gill tissue, causing necrosis and rot. More common in warm water with high organic load. Symptoms include rapid, labored breathing, gasping at surface, gill discoloration (red, then gray/white necrosis), patches of dead gill tissue, lethargy, and sudden death. Gills may have a mottled appearance. Fish essentially suffocate as functional gill tissue is destroyed. Caused by Branchiomyces fungi thriving in warm (77-86°F), oxygen-poor, organically rich water. Treatment is difficult; includes aggressive water changes, lowering temperature if possible, increasing aeration, antifungal medications, and reducing organic load. Mortality rate is high; prevention is key.',
          imageUrl: null,
...

        {
          ...
          description:
            'Chronic health problems caused by inadequate nutrition or vitamin deficiencies. Different deficiencies cause different symptoms. General symptoms include weight loss, stunted growth, lethargy, color loss, weakened immune system, deformities, and increased disease susceptibility. Specific deficiencies: Vitamin C causes spinal deformities, poor wound healing, hemorrhaging; Vitamin A causes eye problems, fin erosion; Thiamine causes neurological issues, loss of equilibrium; Vitamin E causes reproductive failure, fatty liver. Caused by poor diet quality, feeding only one food type, old/stale food (vitamins degrade), improper diet for species (herbivore fed only meat), or overprocessing. Treatment involves varied, high-quality diet appropriate for species, vitamin-enriched foods, fresh/frozen foods, and supplements (garlic-soaked food, vitamin drops). Prevention through proper nutrition is key. Recovery can take weeks to months.',
          imageUrl: null,
      ...
      equipment: [
        {
          ...
          scientificName: null,
          description:
            'Essential equipment that removes debris and maintains water quality through mechanical, chemical, and biological filtration. Types include hang-on-back (HOB), canister, sponge, and internal filters. Choose based on tank size and bioload.',
          imageUrl: null,
        ...
        },
        {
          ...
          scientificName: null,
          description:
            'Device that maintains stable water temperature for tropical fish. Most tropical species need 75-80°F. Choose wattage based on tank size (typically 3-5 watts per gallon). Always use a thermometer to monitor temperature.',
          imageUrl: null,
        ...
        },
        {
          ...
          scientificName: null,
          description:
            'Tools to measure water parameters including pH, ammonia, nitrite, and nitrate levels. Essential for monitoring water quality and cycling new tanks. Available in liquid (more accurate) or strip forms.',
          imageUrl: null,
      ...
      terminology: [
        {
          ...
          scientificName: null,
          description:
            'The biological process where beneficial bacteria convert toxic ammonia (from fish waste) into nitrite, then into less toxic nitrate. Essential for establishing a healthy aquarium. Takes 4-8 weeks to complete in new tanks.',
          imageUrl: null,
        ...
        },
        {
          ...
          scientificName: null,
          description:
            'The total amount of waste produced by all living organisms in the aquarium. Higher bioload requires better filtration and more frequent water changes. Measured by the "one inch of fish per gallon" rule (though this is oversimplified).',
          imageUrl: null,
        ...
        },
        {
          ...
          scientificName: null,
          description:
            'A separate tank used to isolate new fish or sick fish from the main display tank. Prevents disease spread and allows observation of new arrivals. Recommended to quarantine for 2-4 weeks before introducing fish to main tank.',
          imageUrl: null,
...

        {
          ...
          scientificName: null,
          description:
            'Aggressive behavior defending a specific area (territory) from intruders, especially conspecifics (same species). Common in cichlids, bettas, some gouramis, and breeding pairs of many species. Triggers include breeding (most species become territorial when spawning), insufficient space, lack of visual barriers, or too few females in harem species. Symptoms: chasing, fin nipping, physical attacks, stressed/injured fish, or dead tankmates. Manage by providing adequate tank size, caves/territories for each fish, visual barriers (plants, decorations), proper male:female ratios, and avoiding overstocking. Some species (Oscars, Jack Dempseys) require species-only tanks.',
          imageUrl: null,
  ...
  async init() {
    try {
      ...
      this.showGlossaryError(
        'Unable to load glossary data. Please <a href="javascript:location.reload()">refresh the page</a>.'
      );
    }
  }
  ...
  renderPagination(totalPages) {
    ...
    pages.push(
      `<button class="pagination-btn pagination-prev ${prevDisabled}" onclick="glossaryManager.goToPage(${this.currentPage - 1})" ${prevDisabled}>← Previous</button>`
    );
    ...
    if (startPage > 1) {
      pages.push(
        `<button class="pagination-btn pagination-num" onclick="glossaryManager.goToPage(1)">1</button>`
      );
      if (startPage > 2) {
    ...
    for (let i = startPage; i <= endPage; i++) {
      ...
      pages.push(
        `<button class="pagination-btn pagination-num ${activeClass}" onclick="glossaryManager.goToPage(${i})">${i}</button>`
      );
    }
    ...
    if (endPage < totalPages) {
      ...
      pages.push(
        `<button class="pagination-btn pagination-num" onclick="glossaryManager.goToPage(${totalPages})">${totalPages}</button>`
      );
    }
    ...
    pages.push(
      `<button class="pagination-btn pagination-next ${nextDisabled}" onclick="glossaryManager.goToPage(${this.currentPage + 1})" ${nextDisabled}>Next →</button>`
    );
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', () => {
    glossaryManager.init().catch(error => {
      ...
      glossaryManager.showGlossaryError(
        'Critical error loading glossary. Please refresh the page.'
      );
    });
  });
} else {
