...
const fishDescriptions = {
  // Core species
  neonTetra:
    'A small, peaceful freshwater fish known for its bright blue and red coloration. Native to South American blackwater streams, they thrive in schools of 6+ and display stunning iridescent colors under proper lighting. Perfect for community tanks with soft, acidic water.',

  bettaFish:
    'A colorful labyrinth fish known for its flowing fins and territorial behavior toward other males. Can breathe atmospheric air from the surface using their labyrinth organ. Prefers warm water (76-82°F) and does best in filtered, heated tanks with gentle flow.',

  corydoras:
    'Bottom-dwelling catfish that help keep substrate clean through their constant foraging behavior. Social fish that should be kept in groups of 6+ for proper wellbeing. Very peaceful and great for community tanks, with dozens of species available in various patterns and colors.',

  // Researched batch 1-10
  angelfish:
    'Distinctive triangular-shaped cichlids with long, flowing fins and natural striping patterns. Peaceful when not mating but form territorial monogamous pairs during breeding in vegetation-rich environments. Can live 7+ years in well-maintained aquariums with warm water (75-86°F).',

  pearlDanio:
    'Iridescent purple-bodied fish with striking orange lateral stripe and neon eyes, growing 2.4-2.8 inches. Active shoaling species that prefer cooler tropical temperatures and thrive in groups of six or more. Hardy and adaptable to various conditions (73-77°F).',

  celestialPearlDanio:
    'Tiny peaceful nano fish with dark bodies scattered with golden spots and bright red-orange fins with black stripes. Males spar with rivals and court females; they prefer densely vegetated shallow waters. Recently discovered species from Southeast Asian hill streams.',

  guppy:
    'Colorful livebearer with males displaying vibrant flowing fins while females are larger and less colorful. Active and peaceful, they thrive in planted tanks with vegetation and prefer moderate warmth (72-82°F). Hardy with 2-3 year lifespan and suitable for beginners.',

  molly:
    'Colorful livebearer with flattened body and varied fin shapes, available in 8+ color morphs from black to red. Active and sociable but best kept mostly female to prevent harassment. Hardy and prefer warm tropical water (75-82°F) with dense vegetation.',

  platy:
    'Small peaceful livebearer available in 130+ color variations including Mickey Mouse and sunburst patterns. Males smaller with pointed anal fins; females rounder and larger. Very hardy and undemanding, thriving in community tanks with 3-4 year lifespan (72-82°F).',

  swordtail:
    "Named for males' distinctive elongated lower tail lobe resembling a sword, available in 50+ color morphs. Peaceful and active swimmers preferring heavily vegetated environments. Hardy adaptable livebearers with 3-5 year lifespan, best with 2+ females per male.",

  endlersLivebearer:
    'Tiny peaceful livebearer with males displaying striking metallic patterns in green, orange, blue, and yellow. Active schooling fish where males constantly court females with elaborate displays. Very easy breeders producing live fry every 23-30 days in community tanks.',

  whiteCloudMinnow:
    'Small hardy minnow with greenish-bronze body, iridescent blue stripe, and red fins reaching 1.5 inches. Peaceful shoaling fish thriving in groups of five or more with improved color and confidence. Remarkably cold-hardy, surviving 41°F and thriving at 65-77°F.',

  cardinalTetra:
    'Small peaceful tetra with striking iridescent blue stripe running nose to tail and bright red band below. Must be kept in schools of eight or more to show confidence and vibrant coloration. Sensitive to water chemistry changes, preferring slightly acidic water (75-80°F).',

  // Researched batch 51-100
  odessaBarb:
    "The Odessa Barb is a stunning barb with vibrant red coloring and dark stripes, making it one of the most visually striking barbs available. These active swimmers prefer to school with others and do well in planted tanks with moderate water flow. They're generally hardy and good for intermediate aquarists.",

  denisonBarb:
    'Denison Barbs are large, impressive fish featuring striking red and black markings that make them highly sought after by aquarists. They require spacious tanks, good water movement, and thrive in groups of six or more. These fish are semi-aggressive and need careful tankmate selection due to their size and temperament.',
  ...
  leastKillifish:
    "Least Killifish are the smallest livebearing fish, with adults measuring just one inch long, making them ideal for nano tanks. These peaceful, colorful fish prefer densely planted setups and do well in small groups or pairs. They're hardy and excellent for shrimp tanks, though they require stable conditions and quality food.",
  ...
  dwarfChainLoach:
    'Dwarf Chain Loaches are small, peaceful loaches displaying chain-like patterns and active schooling behavior. They require groups of 8-12, soft substrate, and plenty of hiding places to feel secure. These hardy fish are excellent for established community tanks and enjoy foraging in sand substrates.',

  zebraLoach:
    'Zebra Loaches feature distinctive horizontal stripes and peaceful, schooling behavior in groups of 6-8 or more. They prefer soft substrate, caves, and dim lighting, becoming active during dawn and dusk hours. These hardy fish are excellent for larger community tanks and display interesting social hierarchies.',

  clownLoach:
    'Clown Loaches are large, colorful loaches with striking orange and black banding and playful, social behavior. They reach substantial sizes requiring large tanks and do best in groups, creating entertaining displays. These hardy fish are excellent centerpieces but require experienced care and long-term commitment.',
  ...
  pepperedCory:
    'Peppered Corydoras are peaceful bottom-dwellers with spotted gray coloring, playing crucial cleanup roles in established tanks. They require soft substrate for foraging, require groups of 6 or more, and prefer cool to moderate water temperatures. These hardy fish are excellent for planted community tanks and help maintain substrate health.',

  sterbaiCory:
    'Sterbai Corydoras display vibrant orange spots and stripes with peaceful, industrious behavior that benefits tank substrate. They prefer soft substrate, moderate warmth, and groups of 6-12 for optimal social behavior. These hardy, colorful fish are excellent for planted community tanks and establish well in various setups.',

  juliiCory:
    'Julii Corydoras feature intricate spotting patterns and peaceful, active foraging behavior along tank substrates. They require soft substrate, groups of 6 or more, and appreciate gentle water flow. These hardy fish are excellent for established community tanks and help maintain clean, healthy substrates.',

  albinoCory:
    'Albino Corydoras are pale yellow variants displaying peaceful temperament and valuable cleanup behavior in community tanks. They require soft substrate for barbel health, groups of 6-12, and moderate water temperatures. These hardy, visible variants are excellent for monitoring water quality and substrate conditions.',

  saltAndPepperCory:
    'Salt and Pepper Corydoras are small, peaceful fish with spotted gray coloring, thriving in groups of 6-12 in soft substrate. They actively forage, helping maintain substrate health and cleanliness in established tanks. These hardy, easy-care fish are perfect for planted community tanks and nano setups.',
  ...
  flameTetra:
    'Flame Tetras display vibrant red coloring with contrasting black markings and peaceful schooling behavior in groups of 10-15. They prefer planted tanks with soft water and do well alongside other peaceful community fish. These hardy, colorful fish are excellent for intermediate aquarists seeking dramatic red-colored schooling displays.',

  pristellaTetra:
    "Pristella Tetras feature black and white striped dorsal and anal fins creating elegant, distinctive patterns. They're peaceful schooling fish thriving in groups of 8-12 in planted community tanks. These hardy, visually interesting fish are excellent for established tanks and pair well with other peaceful community species.",
